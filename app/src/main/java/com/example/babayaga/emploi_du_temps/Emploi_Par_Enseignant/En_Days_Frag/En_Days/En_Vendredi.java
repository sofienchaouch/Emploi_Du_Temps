...
public class En_Vendredi extends Fragment {
    public RequestQueue mQueue;
    private Context context;
    private ListView En_VendrediListView;
    private static final String TAG = "Vendredi_Frag";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.en_vendredi,container,false);

        En_VendrediListView = (ListView) view.findViewById(R.id.en_vendredi_list);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                         /*   Intent i = new Intent(getApplicationContext(),Groupes.class);
                            ...
                            En_VendrediListView.setAdapter(adapter1);
                            sesssionList.add(S1);
