...
public class En_Lundi extends Fragment {
    public RequestQueue mQueue;
    private Context context;
    private ListView En_LundiListView;
    private static final String TAG = "En_Lundi_Frag";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.en_lundi,container,false);

        En_LundiListView = (ListView) view.findViewById(R.id.en_lundi_list);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                         /*   Intent i = new Intent(getApplicationContext(),Groupes.class);
                            ...
                            En_LundiListView.setAdapter(adapter1);
                            sesssionList.add(S1);
