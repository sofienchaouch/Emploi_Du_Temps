...
public class Mercredi_Frag extends Fragment {
    public RequestQueue mQueue;
    private Context context;
    private ListView MercrediListView;
    private static final String TAG = "Mercredi_Frag";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.mercredi,container,false);




        MercrediListView = (ListView) view.findViewById(R.id.mercredi_list);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                         /*   Intent i = new Intent(getApplicationContext(),Groupes.class);
                            ...
                            MercrediListView.setAdapter(adapter1);
