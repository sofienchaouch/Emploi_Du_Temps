...
public class Gr_Mercredi extends Fragment {

    public RequestQueue mQueue;
    private Context context;
    private ListView Gr_MercrediListView;
    private static final String TAG = "Gr_Mercredi_Frag";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.gr_mercredi,container,false);

        Gr_MercrediListView = (ListView) view.findViewById(R.id.gr_mercredi_list);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                         /*   Intent i = new Intent(getApplicationContext(),Groupes.class);
                            ...
                            JSONObject day = days.getJSONObject(2);
                            ...
                            for (int j = 0; j < 5; j++) {
                                ...
                                if (hour.equals("Pause")&& actor.equals("") ){
                                    ...
                                    sesssionList.add(new Session(subject, actor, room, "11:45-13:45"));
                                } else {
                                    room = s1.getString("room");
                                    subject = s1.getString("subject");
                            ...
                            Gr_MercrediListView.setAdapter(adapter1);
