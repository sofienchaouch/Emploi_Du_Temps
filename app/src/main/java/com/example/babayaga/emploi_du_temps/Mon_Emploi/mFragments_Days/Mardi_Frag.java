...
public class Mardi_Frag extends Fragment {
    public RequestQueue mQueue;
    private Context context;
    private ListView MardiListView;
    private static final String TAG = "Mardi_Frag";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.mardi,container,false);

        MardiListView = (ListView) view.findViewById(R.id.mardi_list);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                         /*   Intent i = new Intent(getApplicationContext(),Groupes.class);
                            ...
                            MardiListView.setAdapter(adapter1);
