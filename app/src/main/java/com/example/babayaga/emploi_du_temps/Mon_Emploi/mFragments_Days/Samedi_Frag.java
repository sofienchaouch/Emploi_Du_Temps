...
public class Samedi_Frag extends Fragment {
    public RequestQueue mQueue;
    private Context context;
    private ListView SamediListView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.samedi,container,false);
        SamediListView = (ListView) view.findViewById(R.id.samedi_list);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                         /*   Intent i = new Intent(getApplicationContext(),Groupes.class);
                            ...
                            SamediListView.setAdapter(adapter1);
