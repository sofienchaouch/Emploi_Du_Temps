...
public class Vendredi_Frag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.vendredi,container,false);
        VendrediListView = (ListView) view.findViewById(R.id.vendredi_list);
