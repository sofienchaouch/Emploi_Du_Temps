...
public class Gr_Jeudi extends Fragment {

    public RequestQueue mQueue;
    private Context context;
    private ListView Gr_JeudiListView;
    private static final String TAG = "Gr_Jeudi_Frag";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.gr_jeudi,container,false);

        Gr_JeudiListView = (ListView) view.findViewById(R.id.gr_jeudi_list);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                         /*   Intent i = new Intent(getApplicationContext(),Groupes.class);
                            ...
                            Gr_JeudiListView.setAdapter(adapter1);
