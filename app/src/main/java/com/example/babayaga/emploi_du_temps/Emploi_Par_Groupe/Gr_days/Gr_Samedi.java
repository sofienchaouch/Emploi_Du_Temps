...
public class Gr_Samedi extends Fragment {

    public RequestQueue mQueue;
    private Context context;
    private ListView Gr_SamediListView;
    private static final String TAG = "Gr_Samedi_Frag";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.gr_samedi,container,false);

        Gr_SamediListView = (ListView) view.findViewById(R.id.gr_samedi_list);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                         /*   Intent i = new Intent(getApplicationContext(),Groupes.class);
                            ...
                            Gr_SamediListView.setAdapter(adapter1);
