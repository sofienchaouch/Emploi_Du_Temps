...
public class En_Mercredi extends Fragment {
    public RequestQueue mQueue;
    private Context context;
    private ListView En_MercrediListView;
    private static final String TAG = "Mercredi_Frag";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.en_mercredi,container,false);

        En_MercrediListView = (ListView) view.findViewById(R.id.en_mercredi_list);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                         /*   Intent i = new Intent(getApplicationContext(),Groupes.class);
                            ...
                            En_MercrediListView.setAdapter(adapter1);
